...
class UsuariosTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setDisplayField('usuario_nombre');
    ...
    {
        $validator
            ->scalar('usuario_nombre')
            ->maxLength('usuario_nombre', 100)
            ->requirePresence('usuario_nombre', 'create')
            ->notEmptyString('usuario_nombre');

        $validator
            ->scalar('usuario_apellido')
            ->maxLength('usuario_apellido', 100)
            ->requirePresence('usuario_apellido', 'create')
            ->notEmptyString('usuario_apellido');

        $validator
            ->scalar('usuario_contrasena')
            ->maxLength('usuario_contrasena', 50)
            ->requirePresence('usuario_contrasena', 'create')
            ->notEmptyString('usuario_contrasena');

        $validator
            ->scalar('usuario_correo')
            ->maxLength('usuario_correo', 100)
            ->requirePresence('usuario_correo', 'create')
            ->notEmptyString('usuario_correo');

        $validator
            ->numeric('usuario_telefono')
            ->requirePresence('usuario_telefono', 'create')
            ->notEmptyString('usuario_telefono');
